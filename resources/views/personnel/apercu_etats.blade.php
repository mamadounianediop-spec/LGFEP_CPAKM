...
@section('title', 'Aperçu États de Paiement - ' . $nomMois[$mois] . ' ' . $annee)
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6 print:hidden">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Aperçu État de Paiement Personnel</h1>
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('personnel.index') }}?tab=etats" 
    ...
    <!-- Document d'aperçu (style professionnel) -->
            ...
            <div class="relative z-10">
                ...
                <div class="flex justify-between items-center border-b-2 border-blue-600 pb-4 mb-6">
                    ...
                    <div class="flex-1 text-center">
                        ...
                        <div class="text-sm text-gray-600 font-bold">Aperçu - {{ $nomMois[$mois] }} {{ $annee }}</div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-5 gap-3 text-sm">
                        <div class="bg-gray-50 p-3 rounded text-center">
                            <div class="text-xs text-gray-600 mb-1">Date de génération</div>
                            <div class="font-bold">{{ now()->format('d/m/Y H:i') }}</div>
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            // Nouvelle logique : pas d'avance = payé intégralement
                            if ($avance == 0) {
