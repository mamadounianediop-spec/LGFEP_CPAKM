    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        ...
        <div class="mb-8 xl:mb-10">
            <div class="flex items-center space-x-3 xl:space-x-4 mb-2">
                <div class="bg-blue-100 p-2 xl:p-3 rounded-lg xl:rounded-xl">
                    <i class="fas fa-user-graduate text-blue-600 text-lg xl:text-2xl"></i>
                </div>
                <div>
                    <h1 class="text-2xl xl:text-3xl font-bold text-gray-900">Gestion des Inscriptions</h1>
                    <p class="text-sm xl:text-base text-gray-600 mt-1 xl:mt-2">Gérez les pré-inscriptions et inscriptions des élèves</p>
                </div>
            </div>
        </div>
